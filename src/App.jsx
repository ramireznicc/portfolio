                  ...
                  <div className="p-6 md:p-8 flex flex-col flex-1">
                    ...
                    <div className="flex flex-col gap-4 mt-auto pt-4">
                      <div className="flex flex-col md:flex-row md:flex-wrap md:items-center gap-2">
                        ...
                        {project.poweredByClaude && (
                          <div className="flex items-center gap-1 text-neutral-400 order-1 md:order-2 md:ml-1">
                            <ClaudeIcon />
...
const ClaudeIcon = () => (
  <svg className="w-3 h-3 shrink-0" viewBox="0 0 24 24" fill="#D97757" aria-hidden="true">
